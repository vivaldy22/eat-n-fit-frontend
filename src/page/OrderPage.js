	...
	<div class="hero-banner hero-banner-sm" > 
		<div class="row mt-5">
			...
			<div class="col-xs-12 col-sm-12 col-sm-offset-0 col-md-2 col-md-offset-1 petunjuk-pemesanan step-1" style={{marginTop:"100px", marginLeft:"100px"}}>
				...
				<div class="petunjuk-pemesanan-desc" style={{ fontFamily:"PT Serif", color:"black", fontSize:"15px", textAlign:"center"}}>Silahkan melakukan <strong>login / registrasi</strong> pada aplikasi
			...
			<div class="col-xs-12 col-sm-12 col-md-2 petunjuk-pemesanan step-2" style={{marginTop:"85px", marginLeft:"15px"}}>
				...
				<div class="petunjuk-pemesanan-desc" style={{ fontFamily:"PT Serif", color:"black", fontSize:"15px", textAlign:"center"}}>Pilih makanan atau paket yang anda inginkan.</div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-2 petunjuk-pemesanan step-3" style={{marginTop:"100px", marginLeft:"15px"}}>
				...
				<div class="petunjuk-pemesanan-desc" style={{ fontFamily:"PT Serif", color:"black", fontSize:"15px", textAlign:"center"}}>Lengkapi data pemesanan Anda, sesuai informasi yang dibutuhkan.</div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-2 petunjuk-pemesanan step-4" style={{marginTop:"100px"}}>
				...
				<div class="petunjuk-pemesanan-desc" style={{ fontFamily:"PT Serif", color:"black", fontSize:"15px", textAlign:"center"}}>Lakukan checkout pemesanan dan pilih metode pembayaran yang diinginkan. </div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-2 petunjuk-pemesanan step-5" style={{marginTop:"100px"}}>
				...
				<div class="petunjuk-pemesanan-desc" style={{ fontFamily:"PT Serif", color:"black", fontSize:"15px", textAlign:"center"}}>Pesanan Anda akan diantar sesuai dengan data yang telah kami terima.</div>
			</div>
		</div>
	</div>
</div>
